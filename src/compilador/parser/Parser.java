...
//#line 45 "gramatica.y"
{
                                                                                ...
                                                                                for (int i = 0; i < listaIdentificadores.size(); i++) {
                                                                                    if (TablaSimbolos.existeLexema(listaIdentificadores.get(i))) {
                                                                                        agregarTipoAIdentificador(listaIdentificadores.get(i), val_peek(2).sval);
...
{ yyval.ival = val_peek(0).ival; yyval.sval = val_peek(0).sval; representacionPolaca.add(val_peek(0).sval);
...
//#line 169 "gramatica.y"
{
                                                                    ...
                                                                    if (TablaSimbolos.existeLexema(nombreFuncion + getAmbitoActual())){
                                                                        agregarError(erroresSemanticos, ERROR_SEMANTICO, "Linea "+ ((Token) val_peek(1).obj).getNumeroDeLinea() + ": Funcion ya declarada en el mismo ambito");
                                                                    }
...
//#line 267 "gramatica.y"
{
                                                                                                    ...
                                                                                                    representacionPolaca.add(((Token) val_peek(4).obj).getLexema());
                                                                                                    String funcion = ambito.peek().substring(1);
                                                                                                    if (!funcion.equals("main")) {
                                                                                                        funcion = funcion + estaAlAlcance(funcion);
                                                                                                        if (!val_peek(2).sval.equals(TablaSimbolos.getTipoRetorno(funcion))) {
                                                                                                            agregarError(erroresSemanticos, ERROR_SEMANTICO, "Linea "+ ((Token) val_peek(4).obj).getNumeroDeLinea() + ": El tipo del retorno no coincide con el tipo de retorno de la funcion");
                                                                                                        }
                                                                                                    }
                                                                                                }
break;
...
//#line 504 "gramatica.y"
{
                                                                            ...
                                                                            if (ambito == null) {
                                                                                agregarError(erroresSemanticos, ERROR_SEMANTICO, "Linea "+ val_peek(2).ival + ": Variable " + identificador +" no declarada o no esta al alcance");
                                                                            } else if (!TablaSimbolos.getTipo(identificador + ambito).equals(TablaSimbolos.ULONGINT)) {
                                                                                agregarError(erroresSemanticos, ERROR_SEMANTICO, "Linea " + val_peek(2).ival + ": No se puede operar con variables que no sean ULONGINT");
                                                                            }
...
//#line 544 "gramatica.y"
{
                                                                    ...
                                                                    yyval.sval = val_peek(2).sval;
                                                                    if (!(val_peek(2).sval == null || val_peek(1).sval == null) && !(val_peek(2).sval).equals(val_peek(0).sval)) {
                                                                        agregarError(erroresSemanticos, ERROR_SEMANTICO, "Linea "+ Parser.lex.getNumeroDeLinea() + ": incompatibilidad de tipos. " + val_peek(2).sval + ((Token) val_peek(1).obj).getLexema() +val_peek(0).sval);
                                                                    };
                                                                   }
break;
...
//#line 567 "gramatica.y"
{
                                                ...
                                                if (ambitoEncontrado != null) {
                                                    String tipoIdentificador = TablaSimbolos.getTipo(val_peek(0).sval + ambitoEncontrado);
                                                    yyval.sval =  tipoIdentificador;

                                                    if (!tipoIdentificador.equals(TablaSimbolos.ULONGINT) && !tipoIdentificador.equals(TablaSimbolos.SINGLE)) {
                                                        agregarError(erroresSemanticos, ERROR_SEMANTICO, "Linea " + val_peek(0).ival + ": No se puede operar con variables que no sean ULONGINT o SINGLE");
                                                    }
                                                } else {
...
//#line 630 "gramatica.y"
{
                                                                                                        ...
                                                                                                        if (ambitoFuncion != null) {
                                                                                                            ...
                                                                                                            agregarError(erroresSemanticos, ERROR_SEMANTICO, "Linea "+ ((Token) val_peek(3).obj).getNumeroDeLinea() + ": Funcion " + lexemaFuncion +" no esta declarada o no esta al alcance");
                                                                                                        }
                                                                                                       }
break;
case 182:
